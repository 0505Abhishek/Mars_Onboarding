...
const documentPageView = async(req,res)=>{
    ...
    try{
        ...
        let DistributorDocument = await correctionModel.getDistributorDocument(applicationId);
...
const updateBasicPage = async(req,res)=>{
    try{
        ...
        let distributor = await correctionModel.getDistributorById(decodedAppId, req.cookies.email);
...
const updateDocumentPage = async(req,res)=>{
    try{
        ...
        let correction = await correctionModel.getCorrection(decodedAppId);
        let documentData = await leadStatusModel.getDistributorDocument(decodedAppId, req.cookies.user_id);
