...
const editDistributorView = async (req, res) => {
    ...
    let replacementOptions = await editDistributor.getAllDistributor(req.cookies.user_id);
    ...
    res.render('editDistributor', { token: navbarviews, notification: res.notification, distributorData: distributor[0], replacementOptions, regions });
