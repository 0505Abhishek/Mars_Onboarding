...
const updateDistributor = async(req,res)=>{
    ...
    if(distributorData1.length>0)
   {
        ...
        let emailObj= {sendToEmail: hierarchyData[0]?.email_id, sendToName: hierarchyData[0]?.employee_name, sendByName: UserName, firmName: distributorData[0]?.firmName, SendToRole: hierarchyData.role};
...
const  CorrectionDistributorView = async(req,res)=>{
        ...
        let replacementOptions = await correctionctrl.getAllDistributor();
