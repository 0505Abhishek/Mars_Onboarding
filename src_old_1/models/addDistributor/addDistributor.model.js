...
const getAllDistributor = async()=>{
 try{
    return new Promise((resolve, reject) => {
        const query = `SELECT firmName FROM prospective_info`;
