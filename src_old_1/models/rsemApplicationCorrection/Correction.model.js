...
const getDistributorList = async (user_id) => {
    try{
      ...
      where prospective_info.applicationStatus = 'Correction' and prospective_info.flag = 3 and user_id = ? and applicationPhase_Flag = ?`;
...
module.exports={getTerritory, getDistributorList, getDistributorById, updateDistributor, getUserById, updateApprovalWorkFlow, getAllDistributor};