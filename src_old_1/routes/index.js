...
const offboardPage = require("../routes/offboard/offbooard.route");
const webPage = require("../routes/webPage/webPage.route");
const thankYou = require("../routes/thankYou/thankYou.route");
const offboardResignation = require("../routes/offboardResignation/resignation.route"); 
const offboardApplication = require("../routes/offboardingApplication/application.route");
const offboardApprover = require("../routes/offboardApprover/approver.route");
...
const routes = [
    ...
    {
        path:'/offboardResignation',
        route:offboardResignation
    },
    {
        path:'/offboardApplication',
        route:offboardApplication
    },
    {
        path:'/offboardApprover',
        route:offboardApprover
    }
